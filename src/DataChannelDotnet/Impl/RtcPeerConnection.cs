...
namespace DataChannelDotnet.Impl
{
	...
	public unsafe sealed class RtcPeerConnection : IRtcPeerConnection
	{
		...
		public string LocalDescription => RtcHelpers.GetString(_peerId, Rtc.rtcGetLocalDescription, _lock, ref _disposed, nameof(RtcPeerConnection));
		public RtcDescriptionType LocalDescriptionType => GetLocalDescriptionType();
		public string RemoteDescription => RtcHelpers.GetString(_peerId, Rtc.rtcGetLocalDescription, _lock, ref _disposed, nameof(RtcPeerConnection));
		public RtcDescriptionType RemoteDescriptionType => GetRemoteDescriptionType();
		public string LocalAddress => RtcHelpers.GetString(_peerId, Rtc.rtcGetLocalAddress, _lock, ref _disposed, nameof(RtcPeerConnection));
		public string RemoteAddress => RtcHelpers.GetString(_peerId, Rtc.rtcGetRemoteAddress, _lock, ref _disposed, nameof(RtcPeerConnection));
		...
		public RtcPeerConnection(RtcPeerConfiguration configuration)
		{
			...
			try
			{
				...
				unsafe
				{
					...
					RtcConnectionStateCallbackFunc connectionStateCallback = StaticOnConnectionStateCallback;
					RtcSignalingStateCallbackFunc signalingStateCallback = StaticOnSignalingStateCallback;
					RtcIceStateCallbackFunc iceStateCallback = StaticOnIceStateChangeCallback;
					RtcGatheringStateCallbackFunc gatheringStateCallback = StaticOnGatheringStateCallback;
					RtcLocalCandidateCallbackFunc localCandidateCallback = StaticOnLocalCandidateCallback;
					RtcLocalDescriptionCallbackFunc localDescriptionCallback = StaticOnLocalDescriptionCallback;
					RtcDataChannelCallbackFunc dataChannelCallback = StaticOnDataChannelCallback;
					RtcTrackCallbackFunc trackCallback = StaticOnTrackCallback;

					IntPtr connectionStatePtr = Marshal.GetFunctionPointerForDelegate(connectionStateCallback);
					IntPtr signalingStatePtr = Marshal.GetFunctionPointerForDelegate(signalingStateCallback);
					IntPtr iceStatePtr = Marshal.GetFunctionPointerForDelegate(iceStateCallback);
					IntPtr gatheringStatePtr = Marshal.GetFunctionPointerForDelegate(gatheringStateCallback);
					IntPtr localCandidatePtr = Marshal.GetFunctionPointerForDelegate(localCandidateCallback);
					IntPtr localDescriptionPtr = Marshal.GetFunctionPointerForDelegate(localDescriptionCallback);
					IntPtr dataChannelPtr = Marshal.GetFunctionPointerForDelegate(dataChannelCallback);
					IntPtr trackPtr = Marshal.GetFunctionPointerForDelegate(trackCallback);

					Rtc.rtcSetStateChangeCallback(_peerId, (delegate* unmanaged[Cdecl]<int, rtcState, void*, void>)connectionStatePtr).GetValueOrThrow();
					Rtc.rtcSetSignalingStateChangeCallback(_peerId, (delegate* unmanaged[Cdecl]<int, rtcSignalingState, void*, void>)signalingStatePtr).GetValueOrThrow();
					Rtc.rtcSetIceStateChangeCallback(_peerId, (delegate* unmanaged[Cdecl]<int, rtcIceState, void*, void>)iceStatePtr).GetValueOrThrow();
					Rtc.rtcSetGatheringStateChangeCallback(_peerId, (delegate* unmanaged[Cdecl]<int, rtcGatheringState, void*, void>)gatheringStatePtr).GetValueOrThrow();

					Rtc.rtcSetLocalCandidateCallback(_peerId, (delegate* unmanaged[Cdecl]<int, sbyte*, sbyte*, void*, void>)localCandidatePtr).GetValueOrThrow();
					Rtc.rtcSetLocalDescriptionCallback(_peerId, (delegate* unmanaged[Cdecl]<int, sbyte*, sbyte*, void*, void>)localDescriptionPtr).GetValueOrThrow();
					Rtc.rtcSetDataChannelCallback(_peerId, (delegate* unmanaged[Cdecl]<int, int, void*, void>)dataChannelPtr).GetValueOrThrow();
					Rtc.rtcSetTrackCallback(_peerId, (delegate* unmanaged[Cdecl]<int, int, void*, void>)trackPtr).GetValueOrThrow();
				}
			}
			catch (Exception)
			{
		...
		private unsafe int CreateRtcPeer(RtcPeerConfiguration configuration)
		{
			...
			{
				iceServers = new string[configuration.IceServers.Count];
				configuration.IceServers.CopyTo(iceServers, 0);
			}
			using NativeUtf8StringArray iceServersArray =
				new NativeUtf8StringArray(iceServers ?? new string[0]);
		...
		public unsafe void SetRemoteDescription(RtcDescription description)
		{
			using (_lock.EnterScope())
			{
				...
				using NativeUtf8String typeString = new NativeUtf8String(typeStr);

				Rtc.rtcSetRemoteDescription(_peerId, sdpString.Ptr, typeString.Ptr).GetValueOrThrow();
			}
		}
		...
		public unsafe void SetLocalDescription(RtcDescriptionType type)
		{
			using (_lock.EnterScope())
			{
				...
				using NativeUtf8String typeString = new NativeUtf8String(typeStr);
				Rtc.rtcSetLocalDescription(_peerId, typeString.Ptr).GetValueOrThrow();
			}
		}

		public bool TryGetSelectedCandidatePair(out RtcCandidatePair pair)
		{
			return RtcHelpers.TryGetSelectedCandidatePair(_peerId, _lock, ref _disposed, out pair);
		}
		...
		private delegate void RtcConnectionStateCallbackFunc(int id, rtcState state, void* user);

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void RtcSignalingStateCallbackFunc(int id, rtcSignalingState state, void* user);

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void RtcIceStateCallbackFunc(int id, rtcIceState state, void* user);

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void RtcGatheringStateCallbackFunc(int id, rtcGatheringState state, void* user);

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void RtcLocalCandidateCallbackFunc(int id, sbyte* candidate, sbyte* mid, void* user);

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void RtcLocalDescriptionCallbackFunc(int id, sbyte* sdpStr, sbyte* typeStr, void* user);

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void RtcDataChannelCallbackFunc(int id, int channelId, void* user);

		[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
		private delegate void RtcTrackCallbackFunc(int id, int trackId, void* user);
